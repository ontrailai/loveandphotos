import{j as e,d as y,i as q,P as L,h as R,n as U,c as F,r as V,A as Q,Z as H,D as O,_ as G}from"./ui-PDrb_6Oa.js";import{r as x}from"./react-C3Xvg9zH.js";import{u as J,b as W,L as P}from"./router-BOsq01yh.js";import{s as m,u as X,C as v,a as b,B as g}from"./index-ZSaHo8n_.js";import{f as p}from"./utils-CWWonWgh.js";import{z as u}from"./notifications-AAMUpyrg.js";import"./auth-BAx15x3q.js";import"./forms-BETPFrzU.js";const k=async({bookingId:t,recipientType:o})=>{try{const{data:a,error:l}=await m.from("bookings").select(`
        *,
      ...
      `).eq("id",t).single();if(l)throw l;const i=o==="customer"?{email:a.customer.email,name:a.customer.full_name,type:"customer"}:{email:a.photographers.users.email,name:a.photographers.users.full_name,type:"photographer"},d=o==="customer"?Z(a):K(a),{data:s,error:h}=await m.functions.invoke("send-email",{body:{to:i.email,subject:d.subject,html:d.html,text:d.text}});return h&&(console.error("Email send error:",h),await ee({bookingId:t,recipientType:o,recipient:i,content:d})),{success:!0,data:s}}catch(a){throw console.error("Error sending confirmation email:",a),a}},Z=t=>{const o=p(new Date(t.event_date),"EEEE, MMMM dd, yyyy"),a=t.contract_url||"#",l="http://localhost:5173/dashboard",i=`http://localhost:5173/book/quiz/${t.id}`,d=`Booking Confirmed - ${t.photographers.users.full_name} for ${o}`,s=`
    <!DOCTYPE html>
    <html>
    <head>
      <style>
...
Questions? Contact us at support@loveandphotos.com
  `;return{subject:d,html:s,text:h}},K=t=>{const o=p(new Date(t.event_date),"EEEE, MMMM dd, yyyy"),a="http://localhost:5173/dashboard/photographer/job-queue",l=`New Booking Alert - ${t.customer.full_name} on ${o}`,i=`
    <!DOCTYPE html>
    <html>
    <head>
      <style>
...
//# sourceMappingURL=BookingConfirmation-BHqlCPcw.js.map
