    ...
    <div className="min-h-screen bg-background">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="bg-card rounded-lg shadow-lg p-8 sm:p-12 border">
          ...
          <p className="text-muted-foreground mb-8">Last Updated: September 8th, 2025</p>

          <div className="bg-muted/50 border-l-4 border-primary p-6 mb-8">
            <h2 className="text-xl font-semibold text-foreground mb-3">IMPORTANT:</h2>
          ...
          <div className="space-y-10 text-muted-foreground">
            ...
            <section>
              ...
              <div className="space-y-4">
                <div>
                  <h3 className="text-lg font-semibold text-foreground mb-2">1.1 Package Selection and Confirmation</h3>
                ...
                <div>
                  <h3 className="text-lg font-semibold text-foreground mb-2">1.2 Service Execution</h3>
                  <p className="leading-relaxed">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-foreground mb-2">1.3 Ghosting Policy</h3>
                  <p className="leading-relaxed">
            ...
            <section>
              ...
              <div className="space-y-4">
                <div>
                  <h3 className="text-lg font-semibold text-foreground mb-2">2.1 Payment Requirements</h3>
                  <p className="leading-relaxed">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-foreground mb-2">2.2 Late Booking Fees</h3>
                  <p className="leading-relaxed">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-foreground mb-2">2.3 Immediate Service Commitments</h3>
                  <p className="leading-relaxed">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-foreground mb-2">2.4 Cancellation Policy for Month-to-Month Payment Clients</h3>
                  <p className="leading-relaxed">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-foreground mb-2">2.5 Late Payment Policy</h3>
                  <p className="leading-relaxed">
            ...
            <section>
              ...
              <div className="space-y-4">
                <div>
                  <h3 className="text-lg font-semibold text-foreground mb-2">3.1 Communication and Information Gathering</h3>
                  <p className="leading-relaxed">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-foreground mb-2">3.2 Proof of Insurance</h3>
                  <p className="leading-relaxed">
            ...
            <section>
              ...
              <div className="space-y-4">
                <div>
                  <h3 className="text-lg font-semibold text-foreground mb-2">4.1 Arrival Time and Address</h3>
                  <p className="leading-relaxed">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-foreground mb-2">4.2 Coverage Hours</h3>
                ...
                <div>
                  <h3 className="text-lg font-semibold text-foreground mb-2">4.3 Rescheduling</h3>
                  <p className="leading-relaxed mb-3">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-foreground mb-2">4.4 Contractor Breaks and Vendor Meal</h3>
                  <p className="leading-relaxed">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-foreground mb-2">4.5 Overtime, Travel, and Additional Fees</h3>
                  <p className="leading-relaxed">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-foreground mb-2">4.6 Second Photographer Coverage</h3>
                  <p className="leading-relaxed mb-3">
            ...
            <section>
              ...
              <div className="space-y-4">
                <div>
                  <h3 className="text-lg font-semibold text-foreground mb-2">6.1 Safe Environment</h3>
                  <p className="leading-relaxed">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-foreground mb-2">6.2 Equipment Protection</h3>
                  <p className="leading-relaxed">
            ...
            <section>
              ...
              <div className="space-y-4">
                <div>
                  <h3 className="text-lg font-semibold text-foreground mb-2">7.1 Cancellation and Non-Refundability</h3>
                  <p className="leading-relaxed">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-foreground mb-2">7.2 Rescheduling Fee and Liquidated Damages</h3>
                  <p className="leading-relaxed">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-foreground mb-2">7.3 Studio Cancellation and Refund</h3>
                  <p className="leading-relaxed">
            ...
            <section>
              ...
              <div className="space-y-4">
                <div>
                  <h3 className="text-lg font-semibold text-foreground mb-2">8.1 Delivery of Edited Media and Turnaround Time</h3>
                  <p className="leading-relaxed">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-foreground mb-2">8.2 Rush Delivery Add-On</h3>
                  <p className="leading-relaxed">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-foreground mb-2">8.3 Access Period and Download Rights</h3>
                  <p className="leading-relaxed">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-foreground mb-2">8.4 Exclusion of Raw Materials</h3>
                  <p className="leading-relaxed">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-foreground mb-2">8.5 Re-editing Fees</h3>
                  <p className="leading-relaxed mb-3">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-foreground mb-2">8.6 Backup & Storage</h3>
                  <p className="leading-relaxed mb-3">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-foreground mb-2">8.7 Data Loss Protection</h3>
                  <p className="leading-relaxed">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-foreground mb-2">8.8 Drone Coverage With Video Packages</h3>
                  <p className="leading-relaxed">
            ...
            <section>
              ...
              <div className="space-y-4">
                <div>
                  <h3 className="text-lg font-semibold text-foreground mb-2">9.1 Warranty and "As-Is" Services</h3>
                  <p className="leading-relaxed">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-foreground mb-2">9.2 Professional Exclusivity</h3>
                  <p className="leading-relaxed">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-foreground mb-2">9.3 Copyright and Client Photo Rights</h3>
                  <p className="leading-relaxed">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-foreground mb-2">9.4 WARRANTY OF MERCHANTABILITY</h3>
                  <p className="leading-relaxed">
            ...
            <section>
              ...
              <div className="space-y-4">
                <div>
                  <h3 className="text-lg font-semibold text-foreground mb-2">10.1 Mandatory Arbitration</h3>
                  <p className="leading-relaxed">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-foreground mb-2">10.2 Costs and Fees</h3>
                  <p className="leading-relaxed">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-foreground mb-2">10.3 Governing Law and Jurisdiction</h3>
                  <p className="leading-relaxed">
            ...
            <section>
              ...
              <div className="space-y-4">
                <div>
                  <h3 className="text-lg font-semibold text-foreground mb-2">11.1 Indemnification</h3>
                  <p className="leading-relaxed">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-foreground mb-2">11.2 Assignability and Third-Party Beneficiaries</h3>
                  <p className="leading-relaxed">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-foreground mb-2">11.3 Severability</h3>
                  <p className="leading-relaxed">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-foreground mb-2">11.4 Counterparts and Electronic Signatures</h3>
                  <p className="leading-relaxed">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-foreground mb-2">11.5 Entire Agreement</h3>
                  <p className="leading-relaxed">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-foreground mb-2">11.6 Modifications to Terms and Conditions</h3>
                  <p className="leading-relaxed">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-foreground mb-2">11.7 Website, Social Media, and Sample Displays</h3>
                  <p className="leading-relaxed">
            ...
            <section>
              ...
              <div className="space-y-4">
                <div>
                  <h3 className="text-lg font-semibold text-foreground mb-2">12.1 License Grant</h3>
                  <p className="leading-relaxed mb-3">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-foreground mb-2">12.2 Editing & Cropping</h3>
                  <p className="leading-relaxed">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-foreground mb-2">12.3 Use of Names & Likeness</h3>
                  <p className="leading-relaxed">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-foreground mb-2">12.4 Opt‑Out</h3>
                  <p className="leading-relaxed">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-foreground mb-2">12.5 No Additional Fee</h3>
                  <p className="leading-relaxed">
            ...
            <section>
              ...
              <div className="space-y-4">
                <div>
                  <h3 className="text-lg font-semibold text-foreground mb-2">13.1 Disclaimer of Liability</h3>
                  <p className="leading-relaxed mb-3">
