...
const ContractStep = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      // Create a mock booking ID for now - in real implementation this would come from the booking flow
      const mockBookingId = '12345678-1234-1234-1234-123456789012'
      ...
      // Set appropriate error message based on error type
      if (normalizedError.code === 'REQUEST_TIMEOUT') {
        setSubmitError('Signature submission timed out. Please try again.')
        ...
        setSubmitError('Contract signing service is not available. Please contact support.')
      } else if (normalizedError.status === 403) {
        setSubmitError('Access denied. Please verify your booking details.')
      } else {
