...
import { StarIcon, LockIcon, CheckCircleIcon, MapPinIcon, MessageSquareIcon, CameraIcon } from 'lucide-react'
    ...
    >
      ...
      >
        ...
        <div className="relative h-56 overflow-hidden">
          ...
          >
            <AvailabilityChip level={availability_level} />
          </motion.div>
        ...
        >
          ...
          >
            ...
            <Badge
              variant={computedData.tierName.toLowerCase().includes('gold') ? 'default' : 'secondary'}
              size="sm"
              className={clsx(
                'flex-shrink-0 ml-2 font-medium',
                computedData.tierName.toLowerCase().includes('gold') && 'bg-gradient-to-r from-yellow-400 to-yellow-600 text-white'
              )}
            >
              {computedData.tierName}
            </Badge>
          </motion.div>
          ...
          >
            <Button
              ...
              className="flex-1 hover:bg-[#FF4D6D] hover:text-white hover:border-[#FF4D6D] transition-colors"
            >
            ...
            {showPricing ? (
              <Button
                variant="default"
                size="sm"
                className="flex-1 bg-[#FF4D6D] hover:bg-[#FF4D6D]/90 text-white font-medium"
              >
                ${computedData.hourlyRate}/hr
              </Button>
            ) : (
              <Button
                variant="default"
                size="sm"
                className="flex-1 bg-[#FF4D6D] hover:bg-[#FF4D6D]/90 text-white"
                onClick={(e) => {
                  e.stopPropagation()
          ...
          {languages.length > 0 && (
            <motion.div
              ...
              className="flex flex-wrap gap-1 mt-3 pt-3 border-t border-gray-100"
            >
