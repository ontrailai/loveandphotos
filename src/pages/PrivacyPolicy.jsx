    ...
    <div className="min-h-screen bg-background">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="bg-card rounded-lg shadow-lg p-8 sm:p-12 border">
          ...
          <p className="text-muted-foreground mb-8">Last Updated: February 03, 2025</p>
          ...
          <div className="space-y-8 text-muted-foreground">
            <section>
              ...
              <p className="leading-relaxed">
                Welcome to Love & Photos ("we," "us," "our"). We are committed to protecting your privacy and ensuring you have a positive experience on our website, <a href="https://loveandphotos.com/" className="text-primary hover:text-primary/80 underline">https://loveandphotos.com/</a> ("Site"). This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our Site or otherwise interact with us. By accessing or using our Site, you agree to the terms of this Privacy Policy.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="font-medium">
                <a href="mailto:Matthew@loveandphotos.com" className="text-primary hover:text-primary/80 underline">
