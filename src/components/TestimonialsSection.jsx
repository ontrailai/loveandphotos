          ...
          >
            ...
            <Link to="/book">
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="bg-black text-white hover:bg-black/90 rounded-full h-9 px-4 border border-black/80 focus-visible:ring-black/30 shadow-none transition-colors duration-200 inline-flex items-center font-medium"
              >
